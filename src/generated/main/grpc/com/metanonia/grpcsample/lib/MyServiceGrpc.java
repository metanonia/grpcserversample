...
public final class MyServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.metanonia.grpcsample.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.metanonia.grpcsample.lib.HelloRequest,
      com.metanonia.grpcsample.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.metanonia.grpcsample.lib.HelloRequest.class,
      responseType = com.metanonia.grpcsample.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.metanonia.grpcsample.lib.HelloRequest,
      com.metanonia.grpcsample.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.metanonia.grpcsample.lib.HelloRequest, com.metanonia.grpcsample.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.metanonia.grpcsample.lib.HelloRequest, com.metanonia.grpcsample.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.metanonia.grpcsample.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.metanonia.grpcsample.lib.HelloReply.getDefaultInstance()))
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.metanonia.grpcsample.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<com.metanonia.grpcsample.lib.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.metanonia.grpcsample.lib.HelloRequest,
                com.metanonia.grpcsample.lib.HelloReply>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.metanonia.grpcsample.lib.HelloReply sayHello(com.metanonia.grpcsample.lib.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.metanonia.grpcsample.lib.HelloReply> sayHello(
        com.metanonia.grpcsample.lib.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.metanonia.grpcsample.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.metanonia.grpcsample.lib.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.metanonia.grpcsample.lib.HelloWorldProto.getDescriptor();
    }
